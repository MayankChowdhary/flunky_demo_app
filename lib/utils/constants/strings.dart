class Strings {
  ...
  static const String baseUrl = "https://api.flunkey.app/api/explore/restaurants/";
  ...
  static const String user1id =  "flunkey";
  static const String user1pass =  "password123";
  static const String user2id =  "user";
  static const String user2pass =  "password123";
